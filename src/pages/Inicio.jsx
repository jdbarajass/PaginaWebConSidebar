        ...
        <div className="grid max-w-6xl grid-cols-1 mx-auto mt-4 lg:grid-cols-7 font-display">
          <div className="w-full h-full col-span-full lg:col-span-4 lg:pr-8">
            ...
            <h3 className="mt-3 text-2x1 text-gray-700 leading-relaxed">
              ...
              anteriores y/o solicitar nuevos con base en alguna imagen.
              ArtMotics también posee convenios con otras empresas para realizar
        ...
        >
          <div className="col-span-1 lg:pr-8">
            ...
            <p className="mt-4 text-xl leading-relaxed text-gray-600">
              ArtMotics es una de las principales empresas de venta de productos
              y servicios relacionados con la impresión 3D de Colombia, así como
              una de las empresas más veteranas del sector.
            </p>
