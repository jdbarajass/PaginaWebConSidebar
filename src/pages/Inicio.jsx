...
import Sociales3 from "media/Sociales3.jpg";
        ...
        <div className="grid max-w-6xl grid-cols-1 mx-auto mt-4 lg:grid-cols-7 font-display">
          <div className="w-full h-full col-span-full lg:col-span-4 lg:pr-8">
            ...
            <h3 className="mt-3 text-2x1 text-gray-700 leading-relaxed">
              En esta página Web veremos algunos temas muy importantes. El
              primer tema que se tratará es la tecnología en el estilo de vida
              de las personas, este es el tema central del proyecto. Veremos
              temas de bioquímica en la vida de las personas y también veremos
              temas como análisis combinatorio y la Ley de Lorentz entre otros.
            </h3>
